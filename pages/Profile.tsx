        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              <h3 className="font-bold text-slate-900 mb-4 flex items-center gap-2"><User size={18}/> Informations Personnelles</h3>
              <ul className="space-y-4 text-sm">
                ...
                <li className="flex items-center gap-3 text-slate-600">
                  <ShieldCheck size={16} className="text-green-500"/> Identité Vérifiée (CIN)
                </li>
              </ul>
          ...
          <div className="lg:col-span-2">
            {activeRole === 'tenant' ? (
              <div className="space-y-6">
                 {/* Tenant View */}
                 <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                    <h2 className="text-xl font-bold text-slate-900 mb-6 flex items-center gap-2"><FileText className="text-blue-600"/> Mes Dossiers & Documents</h2>
                    <div className="grid sm:grid-cols-2 gap-4">
                       <div className="p-4 border border-slate-200 rounded-xl bg-slate-50 flex items-start gap-3">
                          ...
                          <div>
                             <h4 className="font-bold text-sm">CIN / Passeport</h4>
                             <p className="text-xs text-green-600 font-medium flex items-center gap-1 mt-1"><CheckCircle size={12}/> Validé</p>
                          </div>
                       </div>
                       <div className="p-4 border border-slate-200 rounded-xl bg-slate-50 flex items-start gap-3">
                          <div className="bg-white p-2 rounded-lg shadow-sm"><FileText size={20} className="text-slate-700"/></div>
                          <div>
                             <h4 className="font-bold text-sm">Carte Étudiant</h4>
                             <p className="text-xs text-green-600 font-medium flex items-center gap-1 mt-1"><CheckCircle size={12}/> Validé (2024/2025)</p>
                          </div>
                       </div>
                    </div>
                 </div>
                 ...
                 <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                    <h2 className="text-xl font-bold text-slate-900 mb-6">Historique des demandes</h2>
                       ...
                       <div className="flex items-center justify-between p-4 border border-slate-100 rounded-xl hover:bg-slate-50 transition">
                          <div className="flex items-center gap-4">
                             ...
                             <div>
                                ...
                                <span className="text-xs px-2 py-0.5 bg-yellow-100 text-yellow-700 rounded-full font-medium">En attente</span>
                             </div>
                          </div>
                       ...
                       <div className="flex items-center justify-between p-4 border border-slate-100 rounded-xl hover:bg-slate-50 transition">
                          <div className="flex items-center gap-4">
                             ...
                             <div>
                                ...
                                <span className="text-xs px-2 py-0.5 bg-red-100 text-red-700 rounded-full font-medium">Refusé</span>
                             </div>
                          </div>
              ...
              <div className="space-y-6">
                 ...
                 <div className="grid grid-cols-2 gap-4">
                     <div className="bg-blue-600 rounded-xl shadow-lg p-6 text-white">
                        <div className="flex justify-between items-center mb-4">
                           <h3 className="font-bold">Revenus</h3>
                     ...
                     <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-6">
                        <div className="flex justify-between items-center mb-4">
                           <h3 className="font-bold text-slate-900">Taux d'occupation</h3>
                 ...
                 <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                     <div className="flex justify-between items-center mb-6">
                        <h2 className="text-xl font-bold text-slate-900 flex items-center gap-2"><Users className="text-blue-600"/> Demandes de Location</h2>
                        <span className="bg-red-100 text-red-600 text-xs font-bold px-2 py-1 rounded-full">2 Nouvelles</span>
                     </div>
                             ...
                             <div key={app.id} className="border border-slate-200 rounded-xl p-5 bg-slate-50 hover:shadow-md transition">
                                 <div className="flex justify-between items-start mb-4">
                                     <div className="flex gap-4">
                                         ...
                                         <div>
                                             <h3 className="font-bold text-slate-900 text-lg">{app.studentName} <span className="text-sm font-normal text-slate-500">({app.studentAge} ans)</span></h3>
                                     ...
                                     <div className="text-right">
                                         <div className="inline-flex items-center gap-1 bg-green-100 text-green-700 px-2 py-1 rounded-lg text-xs font-bold">
                                             <ShieldCheck size={12}/> Fiabilité : {app.reliabilityScore}%
                                         </div>
                                     </div>
                                 </div>
                                 ...
                                 {app.status === 'pending' ? (
                                     <div className="flex gap-3">
                                         <button onClick={() => handleApplicationStatus(app.id, 'accepted')} className="flex-1 bg-slate-900 text-white py-2 rounded-lg font-bold text-sm hover:bg-slate-800 transition flex items-center justify-center gap-2">
                                             <Check size={16}/> Accepter le dossier
                                         </button>
                                     ...
                                     <div className="bg-green-50 text-green-700 p-3 rounded-lg text-center font-bold text-sm flex items-center justify-center gap-2">
                                         <CheckCircle size={16}/> Dossier Accepté - En attente de signature
                                     </div>
                                 ) : (
                 ...
                 <div className="bg-indigo-900 rounded-xl shadow-lg p-6 text-white overflow-hidden relative">
                    ...
                    <div className="relative z-10">
                        <h2 className="text-xl font-bold mb-2 flex items-center gap-2"><ShieldCheck className="text-green-400"/> SmartCheck Locataire</h2>
                        <p className="text-indigo-200 text-sm mb-6">Vérifiez la fiabilité d'un candidat avant de signer. Données basées sur l'historique Room.ma.</p>
                        
                        <form onSubmit={handleCheckTenant} className="flex gap-2 mb-6">
                            <input 
                                type="email" 
                                placeholder="Email ou ID du locataire..." 
                                value={checkEmail}
                            ...
                            <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20 animate-fade-in">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="font-bold text-lg">Score de Fiabilité</p>
                                            <p className="text-xs text-green-300 font-medium uppercase tracking-wider">{checkResult.status}</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                         <div className="flex items-center gap-1 text-yellow-400 font-bold"><ShieldCheck size={14}/> Profil Certifié</div>
                                    </div>
                                </div>
                                <div className="grid grid-cols-3 gap-2 text-center text-sm">
                                    ...
                                    <div className="bg-indigo-950/50 p-2 rounded-lg">
                                        <p className="text-indigo-300 text-xs mb-1">Avis Bailleurs</p>
                 ...
                 <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                    <div className="flex justify-between items-center mb-6">
                       <h2 className="text-xl font-bold text-slate-900 flex items-center gap-2"><Home className="text-blue-600"/> Mes Annonces</h2>
                    ...
                    <div className="text-center py-12 border-2 border-dashed border-slate-200 rounded-xl">
                       ...
                       <p className="text-slate-500 font-medium">Vous n'avez aucune annonce active.</p>
                       <button className="text-blue-600 text-sm font-bold mt-2 hover:underline">Publier mon premier bien</button>
                    </div>
                 </div>
              </div>
            )}
